...
### list
 ...
 did everything except the learnWeb3 lesson and the workout plan I do have some time but I don't feel like working anymore so we'll see if my mood changes after going to a walk.
...
### list
 - [x] read the last journal
 - [x] complete ost 2 mark
 - [x] get the cohort stuff done
 - [ ] odin project lesson/ learn web3 lesson
 - [x] assign specific time for journaling
 - [x] dsa lessons
 - [x] write the script for the video
 - [ ] record the video
 - [ ] Make the workout plan
 - [x] journal
